...
$(document).ready(function(){
	...
	$( "#btn_refresh" ).click(function() {
		location.href = "<c:url value='/displayBrightnessListView.do'/>";
	});
...
function fn_page(pageNo){
	...
	document.frm.action = '<c:url value="/displayBrightnessListView.do"/>';
	document.frm.submit();
}
// 목록 조회
...
<div class = "body">
	...
	<input type="hidden" id="msgActionType" name="msgActionType" value="displayBrightness">
