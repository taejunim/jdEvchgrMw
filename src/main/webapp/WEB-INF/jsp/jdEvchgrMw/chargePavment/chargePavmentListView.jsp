...
$(document).ready(function(){
	...
	$( "#btn_refresh" ).click(function() {
		location.href = "<c:url value='/chargePavmentListView.do'/>";
	});
...
function fn_page(pageNo){
	...
	document.frm.action = '<c:url value="/chargePavmentListView.do"/>';
	document.frm.submit();
}
// 목록 조회
...
<div class="page-header">
  <h1>CHARGE PAVMENT<small> MESSAGE LIST</small></h1>
</div>
<div class = "body">
	<%@include file="/WEB-INF/jsp/jdEvchgrMw/menu/menu.jsp"%>	
	<form:form id="frm" name="frm" method="post" autocomplete="off">
	<input type="hidden" id="msgActionType" name="msgActionType" value="chargePavment">
